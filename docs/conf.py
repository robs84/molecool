...
project = 'molecool'
copyright = ("2020, Robert Smith. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A Python package for ananalyzing and visualizing pdb and xyz files.  For MolSSI May Webinar series.',
     'Miscellaneous'),
]
